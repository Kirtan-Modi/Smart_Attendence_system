...
const String data1 = 19ugZ9HT7O4ECXXaZ38HPn-QSSKfemUtAB95GgivJ3BY; //replace with your credentials
...
void setup() {
  ...
  WiFi.mode(WIFI_STA);
  WiFiMulti.addAP(Kirtan, 00000000);  //replace with your credentials
